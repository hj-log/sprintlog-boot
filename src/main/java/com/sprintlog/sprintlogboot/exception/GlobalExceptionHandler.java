...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleValidation(MethodArgumentNotValidException e) {
        ...
        ProblemDetail pd
                = problem(HttpStatus.BAD_REQUEST, ErrorCode.INVALID_INPUT.getCode(),"요청 본문의 일부 필드가 유효하지 않습니다.", "필드 오류");
    ...
    public ProblemDetail handleNotReadable(HttpMessageNotReadableException e) {
        ProblemDetail pd = problem(HttpStatus.BAD_REQUEST, ErrorCode.INVALID_INPUT.getCode(),
