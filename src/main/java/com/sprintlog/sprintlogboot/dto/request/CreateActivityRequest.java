...
import com.sprintlog.sprintlogboot.validation.*;
...
//        @NotEmpty: 공백 문자열 허용 / 빈 문자열, null은 안됨!
        ...
        @Size(max = 10, message =  "태크는 최대 10개까지 붙일 수 있습니다.")
        Set<
                @Size(max = 20, message = "각 태크는 20자를 넘을 수 없습니다.")
                @Pattern(regexp = "^[A-Za-z0-9가-힣_-]+$", message = "태크는 한글, 영문, 숫자, _, -만 쓸 수 있습니다(공백, 특수문자 불가)")
                String> tags,
